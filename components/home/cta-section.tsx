    ...
    <section id="membership" className="mx-auto my-12 grid w-[min(1280px,calc(100%-2rem))] overflow-hidden rounded-2xl bg-[#7A0008] text-white md:grid-cols-[38%_62%]">
      ...
      <div className="flex flex-col justify-center p-8">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <a id="free-trial" href="https://wa.me/918440070555?text=Hi%20HR%20Health%20Club%2C%20I%20would%20like%20to%20book%20my%20free%20trial." target="_blank" rel="noreferrer" className="inline-flex scroll-mt-28 items-center gap-2 rounded-md border border-white/70 px-5 py-3 font-[family-name:var(--font-display)] text-sm font-semibold transition hover:bg-white/10"><CalendarCheck size={17} />BOOK FREE TRIAL <ArrowRight size={17} /></a>
        </div>
      </div>
    </section>
  );
